...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-4">
            ...
            >
                <span
                    >Page {{ units.current_page }} of
                    {{ units.last_page }}</span
                >
        ...
        <Dialog v-model:open="dialogOpen">
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    ...
                    <DialogDescription>Form unit</DialogDescription>
                </DialogHeader>
        ...
        <AlertDialog
            :open="!!deletingUnit"
            @update:open="(v) => !v && (deletingUnit = null)"
        >
            <AlertDialogContent>
                <AlertDialogHeader>
                    <AlertDialogTitle>Delete this unit?</AlertDialogTitle>
                    <AlertDialogDescription>
                        "{{ deletingUnit?.name }}" will be removed. This can't
                        be undone.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel @click="deletingUnit = null"
